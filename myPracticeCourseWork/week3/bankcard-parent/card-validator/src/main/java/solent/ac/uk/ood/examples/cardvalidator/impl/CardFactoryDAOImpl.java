...
import solent.ac.uk.ood.examples.cardvalidator.cvv.impl.VBICvvAlgorythimStrategy;
import solent.ac.uk.ood.examples.cardvalidator.cvv.impl.MTBCvvAlgorythimStrategy;
import solent.ac.uk.ood.examples.cardvalidator.cvv.impl.MLBCvvAlgorythimStrategy;
...
public class CardFactoryDAOImpl implements CardFactoryDAO {
    ...
    public CardFactoryDAOImpl(){
        ...
        ccfv.setCvvAlgorythim(new VNWCvvAlgorythimStrategy());
